...
print("Number of workers in group X1:", X1.varValue)
print("Number of workers in group X2:", X2.varValue)
print("Number of workers in group Y1:", Y1.varValue)
print("Number of workers in group Y2:", Y2.varValue)
print("Number of workers in group Y3:", Y3.varValue)
print("Number of workers in group Y4:", Y4.varValue)
print("Number of workers in group Y5:", Y5.varValue)
